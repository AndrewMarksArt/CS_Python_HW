...
print("For the input data in X_test,")
print("The predicted outputs are")
predicted_labels = knn_all.predict(X_all)
print(predicted_labels)
...
Briefly reflect on how this all went...
  ...
  Started with a K of 15 but while it had a good score it felt to high so 
  I switched it to 11 and then 9. I have lots of issues with the idea of kNN 
  because of the exchange that is being forced on features but I can see how it would be
